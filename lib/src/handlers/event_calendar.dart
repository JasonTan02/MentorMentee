...
import 'package:hello_world/src/handlers/calendar_utils.dart';
import 'package:scoped_model/scoped_model.dart';
import '../provider/calendars/calendar_provider.dart';
...
class _EventCalendarState extends State<EventCalendar> {
  ...
  Widget build(BuildContext context) {
    return buildScopeModels(child: (context) {

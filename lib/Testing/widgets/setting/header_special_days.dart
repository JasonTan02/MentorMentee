...
import 'package:hello_world/src/model/style/select_month_options.dart';
import 'package:hello_world/src/model/style/select_year_options.dart';
import 'package:hello_world/src/widgets/select_day.dart';
import 'package:hello_world/src/widgets/select_month.dart';
import 'package:hello_world/src/widgets/select_year.dart';
    ...
    List<DataPickerItem> selectBottomSheetDate = [
      DataPickerItem(
        ...
        selectDate: SelectDay(
          ...
          dayStyle: DayOptions(selectedTextColor: Colors.blue),
        ),
